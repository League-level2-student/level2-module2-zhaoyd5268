...
public class LeagueOptionPane {
	...
	public static void showCustomizableMessageDialog(String message) {
	...
	// 4. Create another showCustomizableMessageDialog() method that lets us also
	// choose the
	// Message and Title
	// 2 String parameters (one for the message and one for the title)
	public static void showCustomizableMessageDialog(String message, String title) {
	...
	// 6. Create another showCustomizableMessageDialog() method that lets us choose
	// the Message,
	// Title, and Image
	// 3 String parameters (one for the message, one for the title, and one for the
	// fileName)
	public static void showCustomizableMessageDialog(String message, String title, String filename) {
		JFrame frame = new JFrame();
		JLabel image = new JLabel(loadImage(filename));
		JLabel label = new JLabel();
		JPanel panel = new JPanel();
		panel.add(image);
		panel.add(label);
	...
	// CHALLENGE:
	// 1. Create another showCustomizableMessageDialog() method that lets us choose
	// the Message,
	...
	//
	// 2. Change the return type of the 3rd showCustomizableMessageDialog()
	// method(the one right
	// above) to JPanel
	// Make sure to return your panel at the end of that method
	//
	// 3. Call the showCustomizableMessageDialog() method you just modified in this
	// method
